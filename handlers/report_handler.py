...
更新時間: {update_time}"""
    ...
    report_text = template.format(
        ...
        retail_long=report_data.get('retail', {}).get('mtx_long', 25403),  # 使用mtx_long而不是'long'
        retail_short=report_data.get('retail', {}).get('mtx_short', 26085),  # 使用mtx_short而不是'short'
...
def generate_futures_report(report_data, template):
    ...
    return template.format(
        ...
        retail_ratio=report_data.get('retail', {}).get('ratio', 0),
        retail_ratio_prev=report_data.get('retail', {}).get('ratio_prev', 0),
        retail_long=report_data.get('retail', {}).get('mtx_long', 25403),
        retail_short=report_data.get('retail', {}).get('mtx_short', 26085),
...
def generate_retail_report(report_data, template):
    ...
    retail_long = retail.get('mtx_long', 25403)
    retail_short = retail.get('mtx_short', 26085)
